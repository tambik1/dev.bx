	...
	<div class="sidebar">
		...
		<ul class="menu">
			...
			<?php foreach ($config['menu'] as $key => $name): ?>
				<li class="menu-item">
					<a class="<?= $requestUrl === "/homework-7/" . $key . ".php" ? "a-active" : "a-not-active" ?>" href="/homework-7/<?= $key . ".php" ?>"><?= $name ?></a>
				</li>
			<?php
			endforeach; ?>
			<?
	...
	<div class="container">
		<div class="header">
			<form class="search" method="get">
				...
				<a href="/homework-7/plug.php" class="add-submit-movie">Добавить фильм</a>
